...
Right now, I’m searching for the job that will challenge and keep me satisfied for the years to come. I’m leaning towards a remote position. I appreciate flexible working hours and being able to work from anywhere.
...
|   |   |   |   |   |
|---|---|---|---|---|
|Javascript   |Node.js  |AWS   |Typescript   |MongoDB   |
|Firebase   |ReactJS   |SQL   |GCP   |Redux   |
|Postgresql   |Serverless   |HTML   |REST   |PWA   |
|CSS | SASS | Git | GraphQL | Jest|
| Tailwindcss | Next.js| | | |
|||||
...
[Tailwindcssinjs](https://github.com/Arthie/tailwindcssinjs)
