...
export const Footer: FC<HTMLProps<HTMLDivElement>> = props => (
  <footer
    className={clsx(
      "w-full text-teal-100 border-teal-400 border-b-2",
      props.className
    )}
  >
    <div className="m-auto flex max-w-bplg">
      <section>
        <span className="block font-bold">Arthur Petrie</span>
        <a
          href="mailto:contact@arthurpetrie.com"
          className="flex items-center font-semibold text-teal-400 hover:text-teal-100"
        >
          <svg
      ...
      <section className="flex flex-col items-end justify-between w-full">
        ...
        <span className="font-semibold mt-2">© 2019 Arthur Petrie</span>
      </section>
    </div>
  </footer>
);
...
export const FooterLink: FC<FooterLinkProps> = ({
  ...
  <li>
    <a
      className="flex items-center uppercase text-teal-400 hover:text-teal-100 font-semibold"
      title={title}
      href={href}
